         ...
         <div className="">
          ...
          <ul className=" list-unstyled mb-0">
           <li className="d-flex align-items-center mb-2">
            ...
            <div className="text">
             <p className="mb-0"><a href="tel:+1234567890" className="text-white text-decoration-none">+91 123 456 7890</a></p>
            </div>
           </li>
           <li className="d-flex align-items-center">
            ...
            <div className="text">
             <p className="mb-0"><a href="mailto:info@earagroup.com" className="text-white text-decoration-none">info@earagroup.com</a></p>
            </div>
           </li>
          </ul>
         </div>
