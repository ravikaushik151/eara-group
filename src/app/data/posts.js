...
export const posts = [
  {
    ...
    `,
    keywords: "integrated township, modern living, urban development, gated community benefits",
...

  {
    ...
    `,
    keywords: "eco-friendly balcony, green architecture, sustainable urban living, vertical gardens",
...

  {
    ...
    content: `
      ...
      <ul>
        <li>App-controlled lighting and climate</li>
        <li>Modular, space-saving furniture</li>
        <li>Soft, nature-inspired color palettes</li>
        <li>Noise-cancellation and ambient sound setups</li>
      </ul>
      <p>The future of bedrooms is about creating restful, responsive spaces that adapt to your needs.</p>
    `,
    keywords: "smart bedroom design, 2025 interior trends, home automation, modern bedroom tech",
